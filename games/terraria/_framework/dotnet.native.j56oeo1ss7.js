...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 57868288;
...
var ASM_CONSTS = {
 ...
 11359414: () => Module["SDL3"].audioContext.sampleRate,
 11359465: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 11365019: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 11365078: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 11376273: () => window.innerWidth,
 11376303: () => window.innerHeight,
 11376334: $0 => {
