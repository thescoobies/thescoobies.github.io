...
var ASM_CONSTS = {
 ...
 1388178: () => Module["SDL3"].audioContext.sampleRate,
 1388229: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1393783: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1393842: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 1405037: () => window.innerWidth,
 1405067: () => window.innerHeight,
 1405098: $0 => {
 ...
 wasmFS$backends[backend] = {
  ...
  write: (file, buffer, length, offset) => {
   try {
    ...
    wasmFS$JSMemoryFiles[file].set(GROWABLE_HEAP_U8().subarray(buffer, buffer + length), offset);
    return length;
   } catch (err) {
    return -29;
   }
  ...
  read: (file, buffer, length, offset) => {
   ...
   GROWABLE_HEAP_U8().set(fileData.subarray(offset, offset + length), buffer);
   return length;
  },
...
async function __wasmfs_jsimpl_async_read(ctx, backend, file, buffer, length, offset, result_p) {
 ...
 GROWABLE_HEAP_U32()[((result_p) >> 2)] = result;
 _emscripten_proxy_finish(ctx);
}
...
DOTNET.setup({
 ...
 gitHash: "80aa709f5d919c6814726788dc6dabe23e79e672"
});
